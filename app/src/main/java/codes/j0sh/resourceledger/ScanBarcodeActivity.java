...
import codes.j0sh.resourceledger.controllers.*;

import java.io.IOException;

public class ScanBarcodeActivity extends AppCompatActivity implements BarcodeTracker.BarcodeGraphicTrackerCallback {
